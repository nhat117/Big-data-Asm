...
curl -s \
  ...
  "config": {
    ...
    "contactPoints": "cassandradb",
    "loadBalancing.localDc": "datacenter1",
    "topic.twelvedata.kafkapipeline.twelvedata.mapping": "datetime = value.datetime, macd=value.macd, macd_signal=value.macd_signal, macd_hist=value.macd_hist",
    "topic.twelvedata.kafkapipeline.twelvedata.consistencyLevel": "LOCAL_QUORUM"
  }
}'
echo "Done."
